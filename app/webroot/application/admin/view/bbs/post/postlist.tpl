                ...
                <div class="well">
                    <form action="" class="form form-inline">
                        ...
                        <div class="form-group">
                            ...
                            <button type="button" class="btn btn-danger" v-on:click="delMore">关闭</button>
                            <button type="button" class="btn btn-danger" v-on:click="delMore">显示</button>
                            <button type="button" class="btn btn-danger" v-on:click="delMore">删除</button>
                        </div>
                    </form>
                </div>
