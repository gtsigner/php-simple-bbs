            ...
            var app = new Vue({
                ...
                methods: {
                    loadData: function (pageNum) {
                        ...
                        self.data_list = [];
                        $.post("{:url('system.level/getUserLevel')}",{page:pageNum}, function (ret) {
                    ...
                    del: function (id) {
                        ...
                        layer.confirm("确认删除么(不可恢复)",{}, function () {
                            $.post("{:url('system.level/delUserLevel')}",{id:id}, function (ret) {
                                layer.msg(ret.msg);
                                self.loadData();
                            });
                        }, function () {
                    ...
                    sureAddEdit: function () {
                        var self = this;
                        $.post("{:url('system.level/addEditUserLevel')}", self.tmp_model, function (ret) {
                            $('#addEditModel').modal('toggle');
                            self.loadData();
                            layer.msg(ret.msg);
                        });
